...
const SelectItem = ({ product, showModal, onClose }) => {
        ...
        <Modal.Body>
          <div className="select-container-parent">
            <div className="select-container container">
              ...
              <div className="top-heading-price-parent">
                ...
                <div>
                  <p className="descraption-select-item">
                    Our top running spicy yet so saucy loaded fries that are
              ...
              <div className="line"></div>
              <div>
                <p className="Loaded-fries-text text-left">
                ...
                <div className="preferences-container-input">
                  ...
                  <select className="product-option-select">
                    ...
                    <option value="notify">
                      Notify me for further instructions
                    </option>
                  </select>
                </div>
                <div className="line"></div>
                ...
                <div className="cart-container">
                  ...
                  <button className="cart-button border-0" onClick={handleAddToCart}>
